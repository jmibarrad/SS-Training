...
(function () {
  ...
  app.filter('decimal-roman', function () {
    ...
    var romanValueMap = { 3000: 'MMM', 2000: 'MM', 1000: 'M', 900: 'CM', 500: 'D', 400: 'CD', 100: 'C', 90: 'XC', 50: 'L', 40: 'XL', 10: 'X', 5: 'V', 4: 'IV', 1: 'I' };
    var romanValue = '';

    return function (decimalNumber) {

      if (isNaN(decimalNumber) || decimalNumber > 3999) return decimalNumber;

      while (decimalNumber > 0) {
        var placeValue = void 0;
